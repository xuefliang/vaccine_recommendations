...
def calculate_all_vaccine_recommendations(person_data:pl.dataframe)->pl.dataframe:
    ...
    vaccine_rules = [
        ...
        # 乙肝疫苗第1针
        {
            ...
            'base_date': 'birth_date',
            'offset': '1d',
            'exclude_condition': "(pl.col('vaccine_name')=='乙肝疫苗') &  ((pl.col('age_month') <0) | (pl.col('age') >6))"
        },
        ...
        # 乙肝疫苗第2针
        {
            ...
            'vacc_code': '0201',
            'seq': 2,
            'based_on': {'vaccine': '乙肝疫苗', 'seq': 1},
            'fallback_date': 'birth_date',
            'fallback_offset': '1mo',
            'interval': '1mo',
            'exclude_condition': "(pl.col('vaccine_name')=='乙肝疫苗') & ((pl.col('age_month') <1) | (pl.col('age') >6))"
        },
