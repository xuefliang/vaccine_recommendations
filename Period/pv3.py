...
id_1=jzjc.query('vaccine_name == "脊灰疫苗" & jzjc == 2')['id_x']
pv3_ying0=(
    jzjl
...
# 不符合要求的3剂次接种
id_2=jzjl.query("vaccine_name == '脊灰疫苗' & jc == 3 & year_month > @mon_stat & age <= 6 & months>=4")['id_x']
...
result=pv3_ying0.merge(pv3_ying1, on='current_management_code', how='outer')
result=result.merge(pv3_shi, left_on='current_management_code',right_on='vaccination_org', how='outer')
