...
id_1=jzjc.query('vaccine_name == "含麻疹成分疫苗" & jzjc == 0')['id_x']
mcv1_ying0=(
    person2
...
# 不符合要求的1剂次接种
id_2=jzjl.query("vaccine_name == '含麻疹成分疫苗' & jc == 1 & year_month > @mon_stat & age <= 6 & months>=8")['id_x']
...
result=mcv1_ying0.merge(mcv1_ying1, on='current_management_code', how='outer')
result=result.merge(mcv1_shi, left_on='current_management_code',right_on='vaccination_org', how='outer')
